...
// Program for ATtiny24/44/84
const uint8_t PROG_Tx4[] PROGMEM = {
  ...
  0x83, 0xBF, 0xFF, 0xCF, 0xE1, 0x99, 0xFE, 0xCF, 0x1F, 0xBA, 0x8E, 0xBB, 0xE0, 0x9A, 0x99, 0x27,
  0x8D, 0xB3, 0x08, 0x95, 0xF8, 0x94, 0xFF, 0xCF
};
...
const TGT_TYPE TGTs[] PROGMEM = {
  ...
  {   0x910B,   0x62, 0xDF, 0xFF, 16,   88,     PROG_Tx4, 8000, "ATTINY24  "  },
  {   0x9207,   0x62, 0xDF, 0xFF, 32,   88,     PROG_Tx4, 8000, "ATTINY44  "  },
  {   0x930C,   0x62, 0xDF, 0xFF, 32,   88,     PROG_Tx4, 8000, "ATTINY84  "  },
